...
export default function Error({
  ...
  useEffect(() => {
    console.error("Hydration/Client boundary error caught:", error);
  }, [error]);

  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] flex-1 px-6 text-center gap-6 w-full animate-fade-up">
      <div className="w-16 h-16 rounded-full bg-rose-bg border border-rose-border flex items-center justify-center text-3xl text-rose shadow-sm animate-pulse">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-sm text-ink-3 dark:text-ink-4 max-w-[460px] leading-relaxed">
          Hành trình trồng hoa gặp gián đoạn tạm thời do một lỗi phát sinh. Hãy thử khởi động lại.
        </p>
      </div>
