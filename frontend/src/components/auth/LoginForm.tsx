  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5 animate-in fade-in zoom-in-95 duration-300">
      ...
      <div className="relative flex items-center justify-center mt-2 mb-2">
        ...
        <div className="relative px-4 text-xs font-medium text-slate-400 uppercase bg-white/50 dark:bg-slate-950/50 backdrop-blur-sm rounded-full">
          Hoặc tiếp tục với
        </div>
      </div>

      <div className="flex gap-3">
        <button type="button" className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-slate-800 transition-colors font-medium text-slate-700 dark:text-slate-300 shadow-sm backdrop-blur-sm">
